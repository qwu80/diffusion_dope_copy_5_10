...
text("10\u00B9\u00B3",(153)*s_x,(172)*s_y)

text("10\u00B9\u2074",(153)*s_x,(172-117)*s_y)
...
genBalls_scene1 = (num) =>{
  ...
  // generate *num* balls
if (loopp = true && sceneCount ==0.55 || sceneCount ==  1.5  || sceneCount ==0.5|| sceneCount ==0.7|| sceneCount ==0.71  || sceneCount ==1  || sceneCount ==2 || sceneCount ==3|| sceneCount ==3.1 && whiteArray.length<13000) {
...
genBalls = (num) =>{
  ...
  // generate *num* balls
  if (sceneCount == 13 || sceneCount == 12 || sceneCount ==1.5|| sceneCount ==2||sceneCount ==3){
    // console.log("haha")
    if (time_count>0) {
      whiteArray = [];
      blackArray = [];
